    ...
    <div class="container">
        ...
        if(isset($_GET["page"])) {
            if ($_GET["page"] == "Proceed" || $_GET["page"] == "Skip to Config.php Settings") {
                ...
                echo "<div class='row'><form action=\"update-2.1-to-2.2.php?page=Save Settings\" method='post'>
            ...
            if ($_GET["page"] == "Save Settings") {
                ...
                foreach ($filedata as $data) {
                    ...
                    } else if (stristr($data, '//cwslack-tasks.php') && !$line1) {
                        array_pop($newdata);
                        if ($_POST["hidepasswords"] == "yes") {
                            $newdata[] = '$hidepasswords = 1; //Set to 1 if you want to hide passwords.' . PHP_EOL;
                        } else {
                ...
                echo "</div><div class=\"alert alert-info\" role=\"alert\">Please remove update-2.1-to-2.2.php to avoid people accessing it externally. You can re-add it anytime to configure database or settings again, or just manually edit config.php.</div></div>";
                echo "</div></body></html>";
                die();
            }
        }
        ...
        ?>
                ...
                <?php
                    ...
                    {
                        echo "<form action=\"update-2.1-to-2.2.php\">
